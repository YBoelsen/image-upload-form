        ...
        <div className="m-4">
          ...
          <div className="flex-col items-center justify-center h-96 ">
            ...
            <div className='flex justify-center border-grey border-4 p-10'>
              {file ? <img src={file} className="h-96" width="" id="contentImg" alt="" /> : <svg xmlns="http://www.w3.org/2000/svg"
                className=" h-96 text-gray-400 group-hover:text-gray-600" viewBox="0 0 20 20"
                fill="currentColor">
